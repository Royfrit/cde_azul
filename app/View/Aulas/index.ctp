<div class="aulas index">
	...
	<tr>
		...
		<td><?php echo h($aula['Aula']['distintivo']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $aula['Aula']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $aula['Aula']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
