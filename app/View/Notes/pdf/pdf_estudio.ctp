...
<div class="container" >
 ...
 <div align='center'>
		...
		<div text-align='justify'>
			...
			Quien suscribe hace constar por medio de la presente que el Ciudadano Bachiller: <strong> <?php echo $users['User']['fullname']; ?> </strong> C.I.: <strong> <?php echo $users['User']['ced']; ?> </strong> Esta Inscrito como Alumno Regular de Esta Universidad, en la Carrera de Ingenieria en Informatica.
