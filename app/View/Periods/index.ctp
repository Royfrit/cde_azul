<div class="periods index">
	...
	<tr>
		...
		<td><?php echo h($period['Period']['number']); ?>&nbsp;</td>
		<td><?php echo h($period['Period']['type']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $period['Period']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $period['Period']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
